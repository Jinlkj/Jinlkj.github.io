...
<img src="../images/Guava-1.png" alt="image-20240307002910179" style="zoom:45%;" />
...
<img src="../images/Guava-2.png" alt="image-20240307003229217" style="zoom:50%;" />基于上述公式，Guava就可以在请求到达时计算出当前的令牌桶状态，即桶内令牌数量。然后再根据桶内令牌数量与令牌生成速度计算出何时可以通过请求。这就是Guava限流器实现的令牌桶算法的计算过程。
...
<img src="../images/Guava-3.png" alt="image-20240307003559295" style="zoom:50%;" />
